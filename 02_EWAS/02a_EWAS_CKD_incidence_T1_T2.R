...
#
# EWAS of incident CKD (binary outcome)
# - Baseline (T1)
# - Follow-up (T2)
#
# Study design:
# Nested case-control (1:2 matching)
# n = 274 (92 cases, 182 controls)
#
# Model:
# CKD ~ age + sex + site + cell counts + plate
#
# Notes:
# - Normalised methylation data from Step 01c
# - Cell proportions from Step 01b
############################################
...
############################
# Bacon correction (inflation control)
############################
...
write.table(
  final_T1,
  "CKD_EWAS_T1_incidentCKD_results.txt",
  sep = "\t",
  quote = FALSE,
  row.names = TRUE,
  col.names = TRUE
...
write.table(
  final_T2,
  "CKD_EWAS_T2_incidentCKD_results.txt",
  sep = "\t",
  quote = FALSE,
  row.names = TRUE,
  col.names = TRUE
