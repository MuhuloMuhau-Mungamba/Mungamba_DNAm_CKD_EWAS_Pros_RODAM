############################################
# CKD EWAS – Sensitivity Analysis (Violin Plots ΔeGFR)
...
#
# Purpose:
# - Visualize methylation levels for ΔeGFR-associated CpGs
# - Stratified by site
...
for (cpg in cpgs) {
  ...
  plot_violin(
    df_T1,
    cpg,
    paste0("Violin_", cpg, "_DeltaeGFR_T1_Sensitivity.tiff")
  )
...
for (cpg in cpgs) {
  ...
  plot_violin(
    df_T2,
    cpg,
    paste0("Violin_", cpg, "_DeltaeGFR_T2_Sensitivity.tiff")
  )
